...
const fetchData=(url, callback)=>{ //funkcija fetchData koristi fetch API za slanje HTTP zahteva i upravljanje odgovorom. Prima parametre: URL na koji se šalje HTTP zahtev i
