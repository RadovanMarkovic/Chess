...
const createTestingRooms=()=>{
    const user={username:'testuser', user_rank:'beginner',user_points:1000, room:'room1'}
    const user2={username:'testuser2', user_rank:'expert',user_points:1000, room:'room2'}
